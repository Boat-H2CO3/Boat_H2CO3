...
public class LoginUtils {
    ...
    public LoginUtils(LoginListener listener) {
    ...
    private final Handler checkOrRefreshHandler=new Handler(){
        @Override
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            if (msg.what == 0) {
    ...
    public static void set(String key, String value) {
        H2CO3Tools.setBoatValue(key,value);
    }
    public static String get(String key) {
        return H2CO3Tools.getBoatValueString(key,"Error");
    }
