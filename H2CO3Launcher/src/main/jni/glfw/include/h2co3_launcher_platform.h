...
#define _GLFW_EGL_NATIVE_WINDOW  ((EGLNativeWindowType) window->h2co3_launcher.handle)
#define _GLFW_EGL_NATIVE_DISPLAY EGL_DEFAULT_DISPLAY

#define _GLFW_PLATFORM_WINDOW_STATE         _GLFWwindowH2CO3Launcher  h2co3_launcher
#define _GLFW_PLATFORM_LIBRARY_WINDOW_STATE _GLFWlibraryH2CO3Launcher h2co3_launcher
#define _GLFW_PLATFORM_MONITOR_STATE        _GLFWmonitorH2CO3Launcher h2co3_launcher
#define _GLFW_PLATFORM_CURSOR_STATE         _GLFWcursorH2CO3Launcher  h2co3_launcher
