...
jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    if (dalvikJavaVMPtr == NULL) {
        ...
        class_H2CO3LauncherLib = h2co3Launcher->class_H2CO3LauncherLib;
        method_OpenLink = (*env)->GetStaticMethodID(env, class_H2CO3LauncherLib, "openLink",
                                                    "(Ljava/lang/String;)V");
    }
...
Java_net_java_openjdk_cacio_ctc_CTCDesktopPeer_openFile(JNIEnv *env, jclass clazz,
    ...
    (*dalvikEnv)->CallStaticVoidMethod(dalvikEnv, class_H2CO3LauncherLib, method_OpenLink,
