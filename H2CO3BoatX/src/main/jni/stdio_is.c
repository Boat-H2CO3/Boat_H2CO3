...
JNIEXPORT jint JNI_OnLoad(JavaVM* vm, __attribute((unused)) void* reserved) {
    ...
    jclass eventLogListener = (*env)->FindClass(env, "cosine/boat/logcat/Logger$eventLogListener");
...
Java_cosine_boat_logcat_Logger_begin(JNIEnv *env, __attribute((unused)) jclass clazz, jstring logPath) {
...
JNIEXPORT void JNICALL Java_cosine_boat_LoadMe_setupExitTrap(JNIEnv *env, __attribute((unused)) jclass clazz, jobject context) {
    exitTrap_ctx = (*env)->NewGlobalRef(env,context);
    (*env)->GetJavaVM(env,&exitTrap_jvm);
    exitTrap_exitClass = (*env)->NewGlobalRef(env,(*env)->FindClass(env,"cosine/boat/ExitActivity"));
...
JNIEXPORT void JNICALL Java_cosine_boat_logcat_Logger_appendToLog(JNIEnv *env, __attribute((unused)) jclass clazz, jstring text) {
...
JNIEXPORT void JNICALL
Java_cosine_boat_logcat_setLogListener(JNIEnv *env, __attribute((unused)) jclass clazz, jobject log_listener) {
