...
internal class FragmentTag private constructor() : Tag {
    ...
    override val statusBarViewTag: String =
        "${BuildConfig.LIBRARY_PACKAGE_NAME}_fragment_status_bar"

    override val navigationBarViewTag: String =
        "${BuildConfig.LIBRARY_PACKAGE_NAME}_fragment_navigation_bar"
}