...
typedef void (APIENTRY *glDrawRangeElementsBaseVertexPROC)(jint, jint, jint, jint, jint, intptr_t,
                                                           jint);

typedef void (APIENTRY *glDrawElementsInstancedBaseVertexPROC)(jint, jint, jint, intptr_t, jint,
                                                               jint);

typedef void (APIENTRY *glMultiDrawElementsBaseVertexPROC)(jint, intptr_t, jint, intptr_t, jint,
                                                           intptr_t);
...
Java_org_lwjgl_opengl_GL32C_nglGetBufferParameteri64v__IIJ(JNIEnv
*__env,
jclass clazz, jint
target,
jint pname, jlong
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL32C_nglDrawElementsBaseVertex(JNIEnv
*__env,
jclass clazz, jint
mode,
jint count, jint
type,
jlong indicesAddress, jint
basevertex) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL32C_nglDrawRangeElementsBaseVertex(JNIEnv
*__env,
jclass clazz, jint
mode,
jint start, jint
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL32C_nglDrawElementsInstancedBaseVertex(JNIEnv
*__env,
jclass clazz, jint
mode,
jint count, jint
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL32C_nglMultiDrawElementsBaseVertex__IJIJIJ(JNIEnv
*__env,
jclass clazz, jint
mode,
jlong countAddress, jint
type,
jlong indicesAddress, jint
drawcount,
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL32C_glProvokingVertex(JNIEnv
*__env,
jclass clazz, jint
mode) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL32C_glTexImage2DMultisample(JNIEnv
*__env,
jclass clazz, jint
target,
jint samples, jint
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL32C_glTexImage3DMultisample(JNIEnv
*__env,
jclass clazz, jint
target,
jint samples, jint
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL32C_nglGetMultisamplefv__IIJ(JNIEnv
*__env,
jclass clazz, jint
pname,
jint index, jlong
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL32C_glSampleMaski(JNIEnv
*__env,
jclass clazz, jint
index,
jint mask
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL32C_glFramebufferTexture(JNIEnv
*__env,
jclass clazz, jint
target,
...
JNICALL Java_org_lwjgl_opengl_GL32C_nglIsSync(JNIEnv *__env, jclass clazz, jlong syncAddress) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL32C_nglDeleteSync(JNIEnv
*__env,
jclass clazz, jlong
syncAddress) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL32C_nglWaitSync(JNIEnv
*__env,
jclass clazz, jlong
syncAddress,
jint flags, jlong
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL32C_nglGetInteger64v__IJ(JNIEnv
*__env,
jclass clazz, jint
pname,
jlong paramsAddress
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL32C_nglGetInteger64i_1v__IIJ(JNIEnv
*__env,
jclass clazz, jint
pname,
jint index, jlong
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL32C_nglGetSynciv__JIIJJ(JNIEnv
*__env,
jclass clazz, jlong
syncAddress,
jint pname, jint
