...
Java_org_lwjgl_opengl_ARBGLSPIRV_nglSpecializeShaderARB__IJIJJ(JNIEnv
*__env,
jclass clazz, jint
shader,
...
glSpecializeShaderARBPROC glSpecializeShaderARB = (glSpecializeShaderARBPROC) tlsGetFunction(1116);
