...
Java_org_lwjgl_opengl_NVVertexBufferUnifiedMemory_glBufferAddressRangeNV(JNIEnv
*__env,
jclass clazz, jint
pname,
jint index, jlong
...
glBufferAddressRangeNVPROC glBufferAddressRangeNV = (glBufferAddressRangeNVPROC) tlsGetFunction(
        2183);
UNUSED_PARAM(clazz)
glBufferAddressRangeNV(pname, index, address, (intptr_t)
length);
}

JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_NVVertexBufferUnifiedMemory_glVertexFormatNV(JNIEnv
*__env,
jclass clazz, jint
size,
jint type, jint
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_NVVertexBufferUnifiedMemory_glNormalFormatNV(JNIEnv
*__env,
jclass clazz, jint
type,
jint stride
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_NVVertexBufferUnifiedMemory_glColorFormatNV(JNIEnv
*__env,
jclass clazz, jint
size,
jint type, jint
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_NVVertexBufferUnifiedMemory_glIndexFormatNV(JNIEnv
*__env,
jclass clazz, jint
type,
jint stride
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_NVVertexBufferUnifiedMemory_glTexCoordFormatNV(JNIEnv
*__env,
jclass clazz, jint
size,
jint type, jint
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_NVVertexBufferUnifiedMemory_glEdgeFlagFormatNV(JNIEnv
*__env,
jclass clazz, jint
stride) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_NVVertexBufferUnifiedMemory_glSecondaryColorFormatNV(JNIEnv
*__env,
jclass clazz, jint
size,
jint type, jint
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_NVVertexBufferUnifiedMemory_glFogCoordFormatNV(JNIEnv
*__env,
jclass clazz, jint
type,
jint stride
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_NVVertexBufferUnifiedMemory_glVertexAttribFormatNV(JNIEnv
*__env,
jclass clazz, jint
index,
jint size, jint
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_NVVertexBufferUnifiedMemory_glVertexAttribIFormatNV(JNIEnv
*__env,
jclass clazz, jint
index,
jint size, jint
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_NVVertexBufferUnifiedMemory_nglGetIntegerui64i_1vNV__IIJ(JNIEnv
*__env,
jclass clazz, jint
value,
jint index, jlong
