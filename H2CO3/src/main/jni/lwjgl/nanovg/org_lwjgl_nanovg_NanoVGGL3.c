...
Java_org_lwjgl_nanovg_NanoVGGL3_nnvglImageHandle(JNIEnv *__env, jclass clazz, jlong ctxAddress,
                                                 jint image) {
    NVGcontext *ctx = (NVGcontext *) (uintptr_t) ctxAddress;
    UNUSED_PARAMS(__env, clazz)
...
Java_org_lwjgl_nanovg_NanoVGGL3_nnvgCreate(JNIEnv *__env, jclass clazz, jint flags) {
    UNUSED_PARAM(clazz)
    return (jlong) (uintptr_t) nvgCreateGL3(__env, flags);
}

JNIEXPORT void JNICALL
Java_org_lwjgl_nanovg_NanoVGGL3_nnvgDelete(JNIEnv *__env, jclass clazz, jlong ctxAddress) {
    NVGcontext *ctx = (NVGcontext *) (uintptr_t) ctxAddress;
    UNUSED_PARAMS(__env, clazz)
    nvgDeleteGL3(ctx);
}
...
JNIEXPORT jlong JNICALL
Java_org_lwjgl_nanovg_NanoVGGL3_nnvgluCreateFramebuffer(JNIEnv *__env, jclass clazz,
...
JNIEXPORT void JNICALL
Java_org_lwjgl_nanovg_NanoVGGL3_nnvgluBindFramebuffer(JNIEnv *__env, jclass clazz, jlong ctxAddress,
                                                      jlong fbAddress) {
    NVGcontext *ctx = (NVGcontext *) (uintptr_t) ctxAddress;
...
JNIEXPORT void JNICALL
Java_org_lwjgl_nanovg_NanoVGGL3_nnvgluDeleteFramebuffer(JNIEnv *__env, jclass clazz,
