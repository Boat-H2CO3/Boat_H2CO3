...
Java_org_lwjgl_nanovg_NanoVGGLES2_nnvglCreateImageFromHandle(JNIEnv *__env, jclass clazz,
...
JNIEXPORT jint JNICALL
Java_org_lwjgl_nanovg_NanoVGGLES2_nnvglImageHandle(JNIEnv *__env, jclass clazz, jlong ctxAddress,
                                                   jint image) {
    NVGcontext *ctx = (NVGcontext *) (uintptr_t) ctxAddress;
    UNUSED_PARAMS(__env, clazz)
...
Java_org_lwjgl_nanovg_NanoVGGLES2_nnvgCreate(JNIEnv *__env, jclass clazz, jint flags) {
    UNUSED_PARAM(clazz)
    return (jlong) (uintptr_t) nvgCreateGLES2(__env, flags);
}

JNIEXPORT void JNICALL
Java_org_lwjgl_nanovg_NanoVGGLES2_nnvgDelete(JNIEnv *__env, jclass clazz, jlong ctxAddress) {
    NVGcontext *ctx = (NVGcontext *) (uintptr_t) ctxAddress;
    UNUSED_PARAMS(__env, clazz)
    nvgDeleteGLES2(ctx);
}
...
JNIEXPORT jlong JNICALL
Java_org_lwjgl_nanovg_NanoVGGLES2_nnvgluCreateFramebuffer(JNIEnv *__env, jclass clazz,
...
JNIEXPORT void JNICALL
Java_org_lwjgl_nanovg_NanoVGGLES2_nnvgluBindFramebuffer(JNIEnv *__env, jclass clazz,
...
JNIEXPORT void JNICALL
Java_org_lwjgl_nanovg_NanoVGGLES2_nnvgluDeleteFramebuffer(JNIEnv *__env, jclass clazz,
                                                          jlong ctxAddress, jlong fbAddress) {
    NVGcontext *ctx = (NVGcontext *) (uintptr_t) ctxAddress;
    NVGLUframebuffer *fb = (NVGLUframebuffer *) (uintptr_t) fbAddress;
    UNUSED_PARAMS(__env, clazz)
