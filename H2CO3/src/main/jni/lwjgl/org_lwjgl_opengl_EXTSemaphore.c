...
Java_org_lwjgl_opengl_EXTSemaphore_nglGenSemaphoresEXT__IJ(JNIEnv
*__env,
jclass clazz, jint
n,
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_EXTSemaphore_nglDeleteSemaphoresEXT__IJ(JNIEnv
*__env,
jclass clazz, jint
n,
jlong semaphoresAddress
...
Java_org_lwjgl_opengl_EXTSemaphore_glIsSemaphoreEXT(JNIEnv *__env, jclass clazz, jint semaphore) {
    ...
    UNUSED_PARAM(clazz)
    return (jboolean)
    glIsSemaphoreEXT(semaphore);
}

JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_EXTSemaphore_nglSemaphoreParameterui64vEXT__IIJ(JNIEnv
*__env,
jclass clazz, jint
semaphore,
jint pname, jlong
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_EXTSemaphore_nglGetSemaphoreParameterui64vEXT__IIJ(JNIEnv
*__env,
jclass clazz, jint
semaphore,
jint pname, jlong
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_EXTSemaphore_nglWaitSemaphoreEXT__IIJIJJ(JNIEnv
*__env,
jclass clazz, jint
semaphore,
jint numBufferBarriers, jlong
buffersAddress,
jint numTextureBarriers, jlong
texturesAddress,
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_EXTSemaphore_nglSignalSemaphoreEXT__IIJIJJ(JNIEnv
*__env,
jclass clazz, jint
semaphore,
jint numBufferBarriers, jlong
