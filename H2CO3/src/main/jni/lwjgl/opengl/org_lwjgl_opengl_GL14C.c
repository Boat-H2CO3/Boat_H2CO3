...
Java_org_lwjgl_opengl_GL14C_glBlendColor(JNIEnv *__env, jclass clazz, jfloat red, jfloat green,
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL14C_glBlendEquation(JNIEnv *__env, jclass clazz, jint mode) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL14C_nglMultiDrawArrays__IJJI(JNIEnv *__env, jclass clazz, jint mode,
                                                     jlong firstAddress, jlong countAddress,
                                                     jint drawcount) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL14C_nglMultiDrawElements__IJIJI(JNIEnv *__env, jclass clazz, jint mode,
                                                        jlong countAddress, jint type,
                                                        jlong indicesAddress, jint drawcount) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL14C_glPointParameterf(JNIEnv *__env, jclass clazz, jint pname,
                                              jfloat param) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL14C_glPointParameteri(JNIEnv *__env, jclass clazz, jint pname, jint param) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL14C_nglPointParameterfv__IJ(JNIEnv *__env, jclass clazz, jint pname,
                                                    jlong paramsAddress) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL14C_nglPointParameteriv__IJ(JNIEnv *__env, jclass clazz, jint pname,
                                                    jlong paramsAddress) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL14C_glBlendFuncSeparate(JNIEnv *__env, jclass clazz, jint sfactorRGB,
                                                jint dfactorRGB, jint sfactorAlpha,
                                                jint dfactorAlpha) {
