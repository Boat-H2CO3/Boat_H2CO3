...
Java_org_lwjgl_stb_STBRectPack_nstbrp_1pack_1rects(JNIEnv
*__env,
jclass clazz, jlong
contextAddress,
...
Java_org_lwjgl_stb_STBRectPack_nstbrp_1init_1target(JNIEnv
*__env,
jclass clazz, jlong
contextAddress,
jint width, jint
height,
jlong nodesAddress, jint
num_nodes) {
stbrp_context *context = (stbrp_context *) (intptr_t) contextAddress;
...
JNIEXPORT void JNICALL
Java_org_lwjgl_stb_STBRectPack_nstbrp_1setup_1allow_1out_1of_1mem(JNIEnv
*__env,
jclass clazz, jlong
contextAddress,
...
JNIEXPORT void JNICALL
Java_org_lwjgl_stb_STBRectPack_nstbrp_1setup_1heuristic(JNIEnv
*__env,
jclass clazz, jlong
contextAddress,
jint heuristic
