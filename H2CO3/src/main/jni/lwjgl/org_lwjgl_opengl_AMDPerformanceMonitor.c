...
Java_org_lwjgl_opengl_AMDPerformanceMonitor_nglGetPerfMonitorGroupsAMD__JIJ(JNIEnv
*__env,
jclass clazz, jlong
numGroupsAddress,
jint groupsSize, jlong
groupsAddress) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_AMDPerformanceMonitor_nglGetPerfMonitorCountersAMD__IJJIJ(JNIEnv
*__env,
jclass clazz, jint
group,
jlong numCountersAddress, jlong
maxActiveCountersAddress,
jint counterSize, jlong
countersAddress) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_AMDPerformanceMonitor_nglGetPerfMonitorGroupStringAMD__IIJJ(JNIEnv
*__env,
jclass clazz, jint
group,
jint bufSize, jlong
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_AMDPerformanceMonitor_nglGetPerfMonitorCounterStringAMD__IIIJJ(JNIEnv
*__env,
jclass clazz, jint
group,
jint counter, jint
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_AMDPerformanceMonitor_nglGetPerfMonitorCounterInfoAMD__IIIJ(JNIEnv
*__env,
jclass clazz, jint
group,
jint counter, jint
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_AMDPerformanceMonitor_nglGenPerfMonitorsAMD__IJ(JNIEnv
*__env,
jclass clazz, jint
n,
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_AMDPerformanceMonitor_nglDeletePerfMonitorsAMD__IJ(JNIEnv
*__env,
jclass clazz, jint
n,
jlong monitorsAddress
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_AMDPerformanceMonitor_nglSelectPerfMonitorCountersAMD__IZIIJ(JNIEnv
*__env,
jclass clazz, jint
monitor,
jboolean enable, jint
group,
jint numCounters, jlong
counterListAddress) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_AMDPerformanceMonitor_glBeginPerfMonitorAMD(JNIEnv
*__env,
jclass clazz, jint
monitor) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_AMDPerformanceMonitor_glEndPerfMonitorAMD(JNIEnv
*__env,
jclass clazz, jint
monitor) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_AMDPerformanceMonitor_nglGetPerfMonitorCounterDataAMD__IIIJJ(JNIEnv
*__env,
jclass clazz, jint
monitor,
jint pname, jint
