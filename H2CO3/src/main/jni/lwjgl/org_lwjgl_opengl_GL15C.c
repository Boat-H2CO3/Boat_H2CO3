...
Java_org_lwjgl_opengl_GL15C_glBindBuffer(JNIEnv
*__env,
jclass clazz, jint
target,
jint buffer
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL15C_nglDeleteBuffers__IJ(JNIEnv
*__env,
jclass clazz, jint
n,
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL15C_nglGenBuffers__IJ(JNIEnv
*__env,
jclass clazz, jint
n,
jlong buffersAddress
...
JNICALL Java_org_lwjgl_opengl_GL15C_glIsBuffer(JNIEnv *__env, jclass clazz, jint buffer) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL15C_nglBufferData__IJJI(JNIEnv
*__env,
jclass clazz, jint
target,
jlong size, jlong
...
UNUSED_PARAM(clazz)
glBufferData(target, (intptr_t)
size, data, usage);
}

JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL15C_nglBufferSubData__IJJJ(JNIEnv
*__env,
jclass clazz, jint
target,
jlong offset, jlong
...
dataAddress;
UNUSED_PARAM(clazz)
glBufferSubData(target, (intptr_t)
offset, (intptr_t)size, data);
}

JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL15C_nglGetBufferSubData__IJJJ(JNIEnv
*__env,
jclass clazz, jint
target,
jlong offset, jlong
...
dataAddress;
UNUSED_PARAM(clazz)
glGetBufferSubData(target, (intptr_t)
offset, (intptr_t)size, data);
}
...
JNICALL Java_org_lwjgl_opengl_GL15C_glUnmapBuffer(JNIEnv *__env, jclass clazz, jint target) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL15C_nglGetBufferParameteriv__IIJ(JNIEnv
*__env,
jclass clazz, jint
target,
jint pname, jlong
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL15C_nglGetBufferPointerv(JNIEnv
*__env,
jclass clazz, jint
target,
jint pname, jlong
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL15C_nglGenQueries__IJ(JNIEnv
*__env,
jclass clazz, jint
n,
jlong idsAddress
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL15C_nglDeleteQueries__IJ(JNIEnv
*__env,
jclass clazz, jint
n,
jlong idsAddress
...
JNICALL Java_org_lwjgl_opengl_GL15C_glIsQuery(JNIEnv *__env, jclass clazz, jint id) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL15C_glBeginQuery(JNIEnv
*__env,
jclass clazz, jint
target,
jint id
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL15C_glEndQuery(JNIEnv
*__env,
jclass clazz, jint
target) {
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL15C_nglGetQueryiv__IIJ(JNIEnv
*__env,
jclass clazz, jint
target,
jint pname, jlong
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL15C_nglGetQueryObjectiv__IIJ(JNIEnv
*__env,
jclass clazz, jint
id,
jint pname, jlong
...
JNIEXPORT void JNICALL
Java_org_lwjgl_opengl_GL15C_nglGetQueryObjectuiv__IIJ(JNIEnv
*__env,
jclass clazz, jint
id,
jint pname, jlong
