...
#define EGL_ATTRIBUTES_SIZE 14
#define EGL_VENDOR "Qualcomm"
#define EGL_RENDERER "Adreno"
#define EGL_CONTEXT_ATTRIBUTES_SIZE 3
#define EGL_CONTEXT_CLIENT_VERSION 3
...
bool checkAdrenoGraphics() {
    ...
    EGLint egl_attributes[EGL_ATTRIBUTES_SIZE] = {
            EGL_BLUE_SIZE, 8,
            EGL_GREEN_SIZE, 8,
            EGL_RED_SIZE, 8,
            EGL_ALPHA_SIZE, 8,
    ...
    if (eglChooseConfig(eglDisplay, egl_attributes, NULL, 0, &num_configs) != EGL_TRUE ||
        num_configs == 0) {
    ...
    const EGLint egl_context_attributes[EGL_CONTEXT_ATTRIBUTES_SIZE] = {
            EGL_CONTEXT_CLIENT_VERSION, EGL_CONTEXT_CLIENT_VERSION,
            EGL_NONE
    };
    EGLContext context = eglCreateContext(eglDisplay, eglConfig, EGL_NO_CONTEXT,
    ...
    if (strcmp(vendor, EGL_VENDOR) == 0 && strstr(renderer, EGL_RENDERER) != NULL) {
...
void* load_turnip_vulkan() {
    ...
    void (*linkerhook_pass_handles)(void*, void*, void*) = dlsym(linkerhook, "app__h2co3launcher_linkerhook_pass_handles");
