...
public class InputBox implements OnscreenInput, KeyMap, View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v == buttonFromPre) {
            DialogUtils.createItemsChoiceDialog(mContext, mContext.getString(org.koishi.launcher.h2co3.resources.R.string.title_order), null, mContext.getString(org.koishi.launcher.h2co3.resources.R.string.title_cancel), null, true, ORDERS, new DialogSupports() {
                @Override
