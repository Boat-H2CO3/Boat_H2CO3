...
import org.koishi.launcher.h2co3.control.input.screen.CrossKeyboard;
import org.koishi.launcher.h2co3.control.input.screen.CustomizeKeyboard;
import org.koishi.launcher.h2co3.control.input.screen.InputBox;
import org.koishi.launcher.h2co3.control.input.screen.ItemBar;
import org.koishi.launcher.h2co3.control.input.screen.OnscreenJoystick;
import org.koishi.launcher.h2co3.control.input.screen.OnscreenKeyboard;
...
public class VirtualController extends BaseController implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private MaterialSwitch switchPCKeyboard;
    private ImageButton buttonPEKeyboard;
    private MaterialSwitch switchPEKeyboard;
    private ImageButton buttonPEJoystick;
    private MaterialSwitch switchPEJoystick;
    ...
    private MaterialSwitch switchInputBox;
    ...
    public void init() {
        ...
        for (View v : new View[]{buttonCustomizeKeyboard, buttonOK, buttonResetPos, buttonPCKeyboard, buttonPEKeyboard, buttonPEJoystick, buttonPEItembar, buttonTouchpad, buttonInputBox}) {
            v.setOnClickListener(this);
        }

        for (MaterialSwitch s : new MaterialSwitch[]{switchCustomizeKeyboard, switchPCKeyboard, switchPEKeyboard, switchPEJoystick, switchPEItembar, switchTouchpad, switchInputBox, switchDebugInfo}) {
