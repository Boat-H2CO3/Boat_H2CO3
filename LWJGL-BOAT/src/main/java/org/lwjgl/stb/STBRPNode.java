...
public class STBRPNode extends Struct implements NativeResource {
    ...
    public static short nx(long struct) {
        return UNSAFE.getShort(null, struct + STBRPNode.X);
    }
    ...
    public static short ny(long struct) {
        return UNSAFE.getShort(null, struct + STBRPNode.Y);
    }
    ...
    public static STBRPNode nnext(long struct) {
        return STBRPNode.createSafe(memGetAddress(struct + STBRPNode.NEXT));
    }
