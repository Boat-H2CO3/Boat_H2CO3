...
public class STBTTVertex extends Struct implements NativeResource {
    ...
    public static short nx(long struct) {
        return UNSAFE.getShort(null, struct + STBTTVertex.X);
    }
    ...
    public static short ny(long struct) {
        return UNSAFE.getShort(null, struct + STBTTVertex.Y);
    }
    ...
    public static short ncx(long struct) {
        return UNSAFE.getShort(null, struct + STBTTVertex.CX);
    }
    ...
    public static short ncy(long struct) {
        return UNSAFE.getShort(null, struct + STBTTVertex.CY);
    }
    ...
    public static short ncx1(long struct) {
        return UNSAFE.getShort(null, struct + STBTTVertex.CX1);
    }
    ...
    public static short ncy1(long struct) {
        return UNSAFE.getShort(null, struct + STBTTVertex.CY1);
    }
    ...
    public static byte ntype(long struct) {
        return UNSAFE.getByte(null, struct + STBTTVertex.TYPE);
    }
