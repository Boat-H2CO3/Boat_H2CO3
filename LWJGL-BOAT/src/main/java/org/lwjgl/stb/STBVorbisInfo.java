...
public class STBVorbisInfo extends Struct implements NativeResource {
    ...
    public static int nsample_rate(long struct) {
        return UNSAFE.getInt(null, struct + STBVorbisInfo.SAMPLE_RATE);
    }
    ...
    public static int nchannels(long struct) {
        return UNSAFE.getInt(null, struct + STBVorbisInfo.CHANNELS);
    }
    ...
    public static int nsetup_memory_required(long struct) {
        return UNSAFE.getInt(null, struct + STBVorbisInfo.SETUP_MEMORY_REQUIRED);
    }
    ...
    public static int nsetup_temp_memory_required(long struct) {
        return UNSAFE.getInt(null, struct + STBVorbisInfo.SETUP_TEMP_MEMORY_REQUIRED);
    }
    ...
    public static int ntemp_memory_required(long struct) {
        return UNSAFE.getInt(null, struct + STBVorbisInfo.TEMP_MEMORY_REQUIRED);
    }
    ...
    public static int nmax_frame_size(long struct) {
        return UNSAFE.getInt(null, struct + STBVorbisInfo.MAX_FRAME_SIZE);
    }
