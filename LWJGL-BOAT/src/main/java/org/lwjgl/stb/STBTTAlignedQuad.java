...
public class STBTTAlignedQuad extends Struct implements NativeResource {
    ...
    public static float nx0(long struct) {
        return UNSAFE.getFloat(null, struct + STBTTAlignedQuad.X0);
    }
    ...
    public static float ny0(long struct) {
        return UNSAFE.getFloat(null, struct + STBTTAlignedQuad.Y0);
    }
    ...
    public static float ns0(long struct) {
        return UNSAFE.getFloat(null, struct + STBTTAlignedQuad.S0);
    }
    ...
    public static float nt0(long struct) {
        return UNSAFE.getFloat(null, struct + STBTTAlignedQuad.T0);
    }
    ...
    public static float nx1(long struct) {
        return UNSAFE.getFloat(null, struct + STBTTAlignedQuad.X1);
    }
    ...
    public static float ny1(long struct) {
        return UNSAFE.getFloat(null, struct + STBTTAlignedQuad.Y1);
    }
    ...
    public static float ns1(long struct) {
        return UNSAFE.getFloat(null, struct + STBTTAlignedQuad.S1);
    }
    ...
    public static float nt1(long struct) {
        return UNSAFE.getFloat(null, struct + STBTTAlignedQuad.T1);
    }
