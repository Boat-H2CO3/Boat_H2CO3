...
public class XCirculateRequestEvent extends Struct implements NativeResource {
    ...
    public static int ntype(long struct) {
        return UNSAFE.getInt(null, struct + XCirculateRequestEvent.TYPE);
    }
    ...
    public static long nserial(long struct) {
        return memGetCLong(struct + XCirculateRequestEvent.SERIAL);
    }
    ...
    public static int nsend_event(long struct) {
        return UNSAFE.getInt(null, struct + XCirculateRequestEvent.SEND_EVENT);
    }
    ...
    public static long ndisplay(long struct) {
        return memGetAddress(struct + XCirculateRequestEvent.DISPLAY);
    }
    ...
    public static long nparent(long struct) {
        return memGetCLong(struct + XCirculateRequestEvent.PARENT);
    }
    ...
    public static long nwindow(long struct) {
        return memGetCLong(struct + XCirculateRequestEvent.WINDOW);
    }
    ...
    public static int nplace(long struct) {
        return UNSAFE.getInt(null, struct + XCirculateRequestEvent.PLACE);
    }
    ...
    public static void ntype(long struct, int value) {
        UNSAFE.putInt(null, struct + XCirculateRequestEvent.TYPE, value);
    }
    ...
    public static void nserial(long struct, long value) {
        memPutCLong(struct + XCirculateRequestEvent.SERIAL, value);
    }
    ...
    public static void nsend_event(long struct, int value) {
        UNSAFE.putInt(null, struct + XCirculateRequestEvent.SEND_EVENT, value);
    }
    ...
    public static void ndisplay(long struct, long value) {
        memPutAddress(struct + XCirculateRequestEvent.DISPLAY, check(value));
    }
    ...
    public static void nparent(long struct, long value) {
        memPutCLong(struct + XCirculateRequestEvent.PARENT, value);
    }
    ...
    public static void nwindow(long struct, long value) {
        memPutCLong(struct + XCirculateRequestEvent.WINDOW, value);
    }
    ...
    public static void nplace(long struct, int value) {
        UNSAFE.putInt(null, struct + XCirculateRequestEvent.PLACE, value);
    }
    ...
    public static class Buffer extends StructBuffer<XCirculateRequestEvent, Buffer> implements NativeResource {
        ...
        public Buffer type(int value) {
            XCirculateRequestEvent.ntype(address(), value);
            return this;
        }
        ...
        public Buffer serial(@NativeType("unsigned long") long value) {
            XCirculateRequestEvent.nserial(address(), value);
            return this;
        }
        ...
        public Buffer send_event(@NativeType("Bool") boolean value) {
            XCirculateRequestEvent.nsend_event(address(), value ? 1 : 0);
            return this;
        }
        ...
        public Buffer display(@NativeType("Display *") long value) {
            XCirculateRequestEvent.ndisplay(address(), value);
            return this;
        }
