...
public class XMappingEvent extends Struct implements NativeResource {
    ...
    public static int ntype(long struct) {
        return UNSAFE.getInt(null, struct + XMappingEvent.TYPE);
    }
    ...
    public static long nserial(long struct) {
        return memGetCLong(struct + XMappingEvent.SERIAL);
    }
    ...
    public static int nsend_event(long struct) {
        return UNSAFE.getInt(null, struct + XMappingEvent.SEND_EVENT);
    }
    ...
    public static long ndisplay(long struct) {
        return memGetAddress(struct + XMappingEvent.DISPLAY);
    }
    ...
    public static long nwindow(long struct) {
        return memGetCLong(struct + XMappingEvent.WINDOW);
    }
    ...
    public static int nrequest(long struct) {
        return UNSAFE.getInt(null, struct + XMappingEvent.REQUEST);
    }
    ...
    public static int nfirst_keycode(long struct) {
        return UNSAFE.getInt(null, struct + XMappingEvent.FIRST_KEYCODE);
    }
    ...
    public static int ncount(long struct) {
        return UNSAFE.getInt(null, struct + XMappingEvent.COUNT);
    }
    ...
    public static void ntype(long struct, int value) {
        UNSAFE.putInt(null, struct + XMappingEvent.TYPE, value);
    }
    ...
    public static void nserial(long struct, long value) {
        memPutCLong(struct + XMappingEvent.SERIAL, value);
    }
    ...
    public static void nsend_event(long struct, int value) {
        UNSAFE.putInt(null, struct + XMappingEvent.SEND_EVENT, value);
    }
    ...
    public static void ndisplay(long struct, long value) {
        memPutAddress(struct + XMappingEvent.DISPLAY, check(value));
    }
    ...
    public static void nwindow(long struct, long value) {
        memPutCLong(struct + XMappingEvent.WINDOW, value);
    }
    ...
    public static void nrequest(long struct, int value) {
        UNSAFE.putInt(null, struct + XMappingEvent.REQUEST, value);
    }
    ...
    public static void nfirst_keycode(long struct, int value) {
        UNSAFE.putInt(null, struct + XMappingEvent.FIRST_KEYCODE, value);
    }
    ...
    public static void ncount(long struct, int value) {
        UNSAFE.putInt(null, struct + XMappingEvent.COUNT, value);
    }
    ...
    public static class Buffer extends StructBuffer<XMappingEvent, Buffer> implements NativeResource {
        ...
        public Buffer type(int value) {
            XMappingEvent.ntype(address(), value);
            return this;
        }
        ...
        public Buffer serial(@NativeType("unsigned long") long value) {
            XMappingEvent.nserial(address(), value);
            return this;
        }
        ...
        public Buffer send_event(@NativeType("Bool") boolean value) {
            XMappingEvent.nsend_event(address(), value ? 1 : 0);
            return this;
        }
        ...
        public Buffer display(@NativeType("Display *") long value) {
            XMappingEvent.ndisplay(address(), value);
            return this;
        }
        ...
        public Buffer window(@NativeType("Window") long value) {
            XMappingEvent.nwindow(address(), value);
            return this;
        }
