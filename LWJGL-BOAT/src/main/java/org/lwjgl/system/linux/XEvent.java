...
public class XEvent extends Struct implements NativeResource {
    ...
    public static int ntype(long struct) {
        return UNSAFE.getInt(null, struct + XEvent.TYPE);
    }
    ...
    public static XAnyEvent nxany(long struct) {
        return XAnyEvent.create(struct + XEvent.XANY);
    }
    ...
    public static XKeyEvent nxkey(long struct) {
        return XKeyEvent.create(struct + XEvent.XKEY);
    }
    ...
    public static XButtonEvent nxbutton(long struct) {
        return XButtonEvent.create(struct + XEvent.XBUTTON);
    }
    ...
    public static XMotionEvent nxmotion(long struct) {
        return XMotionEvent.create(struct + XEvent.XMOTION);
    }
    ...
    public static XCrossingEvent nxcrossing(long struct) {
        return XCrossingEvent.create(struct + XEvent.XCROSSING);
    }
    ...
    public static XFocusChangeEvent nxfocus(long struct) {
        return XFocusChangeEvent.create(struct + XEvent.XFOCUS);
    }
    ...
    public static XExposeEvent nxexpose(long struct) {
        return XExposeEvent.create(struct + XEvent.XEXPOSE);
    }
    ...
    public static XGraphicsExposeEvent nxgraphicsexpose(long struct) {
        return XGraphicsExposeEvent.create(struct + XEvent.XGRAPHICSEXPOSE);
    }
    ...
    public static XNoExposeEvent nxnoexpose(long struct) {
        return XNoExposeEvent.create(struct + XEvent.XNOEXPOSE);
    }
    ...
    public static XVisibilityEvent nxvisibility(long struct) {
        return XVisibilityEvent.create(struct + XEvent.XVISIBILITY);
    }
    ...
    public static XCreateWindowEvent nxcreatewindow(long struct) {
        return XCreateWindowEvent.create(struct + XEvent.XCREATEWINDOW);
    }
    ...
    public static XDestroyWindowEvent nxdestroywindow(long struct) {
        return XDestroyWindowEvent.create(struct + XEvent.XDESTROYWINDOW);
    }
    ...
    public static XUnmapEvent nxunmap(long struct) {
        return XUnmapEvent.create(struct + XEvent.XUNMAP);
    }
    ...
    public static XMapEvent nxmap(long struct) {
        return XMapEvent.create(struct + XEvent.XMAP);
    }
    ...
    public static XMapRequestEvent nxmaprequest(long struct) {
        return XMapRequestEvent.create(struct + XEvent.XMAPREQUEST);
    }
    ...
    public static XReparentEvent nxreparent(long struct) {
        return XReparentEvent.create(struct + XEvent.XREPARENT);
    }
    ...
    public static XConfigureEvent nxconfigure(long struct) {
        return XConfigureEvent.create(struct + XEvent.XCONFIGURE);
    }
    ...
    public static XGravityEvent nxgravity(long struct) {
        return XGravityEvent.create(struct + XEvent.XGRAVITY);
    }
    ...
    public static XResizeRequestEvent nxresizerequest(long struct) {
        return XResizeRequestEvent.create(struct + XEvent.XRESIZEREQUEST);
    }
    ...
    public static XConfigureRequestEvent nxconfigurerequest(long struct) {
        return XConfigureRequestEvent.create(struct + XEvent.XCONFIGUREREQUEST);
    }
    ...
    public static XCirculateEvent nxcirculate(long struct) {
        return XCirculateEvent.create(struct + XEvent.XCIRCULATE);
    }
    ...
    public static XCirculateRequestEvent nxcirculaterequest(long struct) {
        return XCirculateRequestEvent.create(struct + XEvent.XCIRCULATEREQUEST);
    }
    ...
    public static XPropertyEvent nxproperty(long struct) {
        return XPropertyEvent.create(struct + XEvent.XPROPERTY);
    }
    ...
    public static XSelectionClearEvent nxselectionclear(long struct) {
        return XSelectionClearEvent.create(struct + XEvent.XSELECTIONCLEAR);
    }
    ...
    public static XSelectionRequestEvent nxselectionrequest(long struct) {
        return XSelectionRequestEvent.create(struct + XEvent.XSELECTIONREQUEST);
    }
    ...
    public static XSelectionEvent nxselection(long struct) {
        return XSelectionEvent.create(struct + XEvent.XSELECTION);
    }
    ...
    public static XColormapEvent nxcolormap(long struct) {
        return XColormapEvent.create(struct + XEvent.XCOLORMAP);
    }
    ...
    public static XClientMessageEvent nxclient(long struct) {
        return XClientMessageEvent.create(struct + XEvent.XCLIENT);
    }
    ...
    public static XMappingEvent nxmapping(long struct) {
        return XMappingEvent.create(struct + XEvent.XMAPPING);
    }
    ...
    public static XErrorEvent nxerror(long struct) {
        return XErrorEvent.create(struct + XEvent.XERROR);
    }
    ...
    public static XKeymapEvent nxkeymap(long struct) {
        return XKeymapEvent.create(struct + XEvent.XKEYMAP);
    }
    ...
    public static XGenericEvent nxgeneric(long struct) {
        return XGenericEvent.create(struct + XEvent.XGENERIC);
    }
