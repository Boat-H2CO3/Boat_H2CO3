...
public class XVisibilityEvent extends Struct implements NativeResource {
    ...
    public static int ntype(long struct) {
        return UNSAFE.getInt(null, struct + XVisibilityEvent.TYPE);
    }
    ...
    public static long nserial(long struct) {
        return memGetCLong(struct + XVisibilityEvent.SERIAL);
    }
    ...
    public static int nsend_event(long struct) {
        return UNSAFE.getInt(null, struct + XVisibilityEvent.SEND_EVENT);
    }
    ...
    public static long ndisplay(long struct) {
        return memGetAddress(struct + XVisibilityEvent.DISPLAY);
    }
    ...
    public static long nwindow(long struct) {
        return memGetCLong(struct + XVisibilityEvent.WINDOW);
    }
    ...
    public static int nstate(long struct) {
        return UNSAFE.getInt(null, struct + XVisibilityEvent.STATE);
    }
    ...
    public static void ntype(long struct, int value) {
        UNSAFE.putInt(null, struct + XVisibilityEvent.TYPE, value);
    }
    ...
    public static void nserial(long struct, long value) {
        memPutCLong(struct + XVisibilityEvent.SERIAL, value);
    }
    ...
    public static void nsend_event(long struct, int value) {
        UNSAFE.putInt(null, struct + XVisibilityEvent.SEND_EVENT, value);
    }
    ...
    public static void ndisplay(long struct, long value) {
        memPutAddress(struct + XVisibilityEvent.DISPLAY, check(value));
    }
    ...
    public static void nwindow(long struct, long value) {
        memPutCLong(struct + XVisibilityEvent.WINDOW, value);
    }
    ...
    public static void nstate(long struct, int value) {
        UNSAFE.putInt(null, struct + XVisibilityEvent.STATE, value);
    }
    ...
    public static class Buffer extends StructBuffer<XVisibilityEvent, Buffer> implements NativeResource {
        ...
        public Buffer type(int value) {
            XVisibilityEvent.ntype(address(), value);
            return this;
        }
        ...
        public Buffer serial(@NativeType("unsigned long") long value) {
            XVisibilityEvent.nserial(address(), value);
            return this;
        }
        ...
        public Buffer send_event(@NativeType("Bool") boolean value) {
            XVisibilityEvent.nsend_event(address(), value ? 1 : 0);
            return this;
        }
        ...
        public Buffer display(@NativeType("Display *") long value) {
            XVisibilityEvent.ndisplay(address(), value);
            return this;
        }
