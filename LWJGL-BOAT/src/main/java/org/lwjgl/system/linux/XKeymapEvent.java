...
public class XKeymapEvent extends Struct implements NativeResource {
    ...
    public byte key_vector(int index) {
        return nkey_vector(address(), index);
    }
    ...
    public XKeymapEvent key_vector(int index, @NativeType("char") byte value) {
        nkey_vector(address(), index, value);
        return this;
    }
    ...
    public static int ntype(long struct) {
        return UNSAFE.getInt(null, struct + XKeymapEvent.TYPE);
    }
    ...
    public static long nserial(long struct) {
        return memGetCLong(struct + XKeymapEvent.SERIAL);
    }
    ...
    public static int nsend_event(long struct) {
        return UNSAFE.getInt(null, struct + XKeymapEvent.SEND_EVENT);
    }
    ...
    public static long ndisplay(long struct) {
        return memGetAddress(struct + XKeymapEvent.DISPLAY);
    }
    ...
    public static long nwindow(long struct) {
        return memGetCLong(struct + XKeymapEvent.WINDOW);
    }
    ...
    public static ByteBuffer nkey_vector(long struct) {
        return memByteBuffer(struct + XKeymapEvent.KEY_VECTOR, 32);
    }
    ...
    public static void ntype(long struct, int value) {
        UNSAFE.putInt(null, struct + XKeymapEvent.TYPE, value);
    }
    ...
    public static void nserial(long struct, long value) {
        memPutCLong(struct + XKeymapEvent.SERIAL, value);
    }
    ...
    public static void nsend_event(long struct, int value) {
        UNSAFE.putInt(null, struct + XKeymapEvent.SEND_EVENT, value);
    }
    ...
    public static void ndisplay(long struct, long value) {
        memPutAddress(struct + XKeymapEvent.DISPLAY, check(value));
    }
    ...
    public static void nwindow(long struct, long value) {
        memPutCLong(struct + XKeymapEvent.WINDOW, value);
    }
    ...
    public static class Buffer extends StructBuffer<XKeymapEvent, Buffer> implements NativeResource {
        ...
        @NativeType("char")
        public byte key_vector(int index) {
            return XKeymapEvent.nkey_vector(address(), index);
        }
        ...
        public Buffer type(int value) {
            XKeymapEvent.ntype(address(), value);
            return this;
        }
        ...
        public Buffer serial(@NativeType("unsigned long") long value) {
            XKeymapEvent.nserial(address(), value);
            return this;
        }
        ...
        public Buffer send_event(@NativeType("Bool") boolean value) {
            XKeymapEvent.nsend_event(address(), value ? 1 : 0);
            return this;
        }
        ...
        public Buffer display(@NativeType("Display *") long value) {
            XKeymapEvent.ndisplay(address(), value);
            return this;
        }
        ...
        public Buffer window(@NativeType("Window") long value) {
            XKeymapEvent.nwindow(address(), value);
            return this;
        }
