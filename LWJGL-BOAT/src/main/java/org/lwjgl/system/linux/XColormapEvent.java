...
public class XColormapEvent extends Struct implements NativeResource {
    ...
    public static int ntype(long struct) {
        return UNSAFE.getInt(null, struct + XColormapEvent.TYPE);
    }
    ...
    public static long nserial(long struct) {
        return memGetCLong(struct + XColormapEvent.SERIAL);
    }
    ...
    public static int nsend_event(long struct) {
        return UNSAFE.getInt(null, struct + XColormapEvent.SEND_EVENT);
    }
    ...
    public static long ndisplay(long struct) {
        return memGetAddress(struct + XColormapEvent.DISPLAY);
    }
    ...
    public static long nwindow(long struct) {
        return memGetCLong(struct + XColormapEvent.WINDOW);
    }
    ...
    public static long ncolormap(long struct) {
        return memGetCLong(struct + XColormapEvent.COLORMAP);
    }
    ...
    public static int nnew$(long struct) {
        return UNSAFE.getInt(null, struct + XColormapEvent.NEW);
    }
    ...
    public static int nstate(long struct) {
        return UNSAFE.getInt(null, struct + XColormapEvent.STATE);
    }
    ...
    public static void ntype(long struct, int value) {
        UNSAFE.putInt(null, struct + XColormapEvent.TYPE, value);
    }
    ...
    public static void nserial(long struct, long value) {
        memPutCLong(struct + XColormapEvent.SERIAL, value);
    }
    ...
    public static void nsend_event(long struct, int value) {
        UNSAFE.putInt(null, struct + XColormapEvent.SEND_EVENT, value);
    }
    ...
    public static void ndisplay(long struct, long value) {
        memPutAddress(struct + XColormapEvent.DISPLAY, check(value));
    }
    ...
    public static void nwindow(long struct, long value) {
        memPutCLong(struct + XColormapEvent.WINDOW, value);
    }
    ...
    public static void ncolormap(long struct, long value) {
        memPutCLong(struct + XColormapEvent.COLORMAP, value);
    }
    ...
    public static void nnew$(long struct, int value) {
        UNSAFE.putInt(null, struct + XColormapEvent.NEW, value);
    }
    ...
    public static class Buffer extends StructBuffer<XColormapEvent, Buffer> implements NativeResource {
        ...
        public Buffer type(int value) {
            XColormapEvent.ntype(address(), value);
            return this;
        }
        ...
        public Buffer serial(@NativeType("unsigned long") long value) {
            XColormapEvent.nserial(address(), value);
            return this;
        }
        ...
        public Buffer send_event(@NativeType("Bool") boolean value) {
            XColormapEvent.nsend_event(address(), value ? 1 : 0);
            return this;
        }
        ...
        public Buffer display(@NativeType("Display *") long value) {
            XColormapEvent.ndisplay(address(), value);
            return this;
        }
        ...
        public Buffer window(@NativeType("Window") long value) {
            XColormapEvent.nwindow(address(), value);
            return this;
        }
