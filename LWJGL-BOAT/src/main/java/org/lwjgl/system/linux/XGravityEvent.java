...
public class XGravityEvent extends Struct implements NativeResource {
    ...
    public static int ntype(long struct) {
        return UNSAFE.getInt(null, struct + XGravityEvent.TYPE);
    }
    ...
    public static long nserial(long struct) {
        return memGetCLong(struct + XGravityEvent.SERIAL);
    }
    ...
    public static int nsend_event(long struct) {
        return UNSAFE.getInt(null, struct + XGravityEvent.SEND_EVENT);
    }
    ...
    public static long ndisplay(long struct) {
        return memGetAddress(struct + XGravityEvent.DISPLAY);
    }
    ...
    public static long nevent(long struct) {
        return memGetCLong(struct + XGravityEvent.EVENT);
    }
    ...
    public static long nwindow(long struct) {
        return memGetCLong(struct + XGravityEvent.WINDOW);
    }
    ...
    public static int nx(long struct) {
        return UNSAFE.getInt(null, struct + XGravityEvent.X);
    }
    ...
    public static int ny(long struct) {
        return UNSAFE.getInt(null, struct + XGravityEvent.Y);
    }
    ...
    public static void ntype(long struct, int value) {
        UNSAFE.putInt(null, struct + XGravityEvent.TYPE, value);
    }
    ...
    public static void nserial(long struct, long value) {
        memPutCLong(struct + XGravityEvent.SERIAL, value);
    }
    ...
    public static void nsend_event(long struct, int value) {
        UNSAFE.putInt(null, struct + XGravityEvent.SEND_EVENT, value);
    }
    ...
    public static void ndisplay(long struct, long value) {
        memPutAddress(struct + XGravityEvent.DISPLAY, check(value));
    }
    ...
    public static void nevent(long struct, long value) {
        memPutCLong(struct + XGravityEvent.EVENT, value);
    }
    ...
    public static void nwindow(long struct, long value) {
        memPutCLong(struct + XGravityEvent.WINDOW, value);
    }
    ...
    public static void nx(long struct, int value) {
        UNSAFE.putInt(null, struct + XGravityEvent.X, value);
    }
    ...
    public static void ny(long struct, int value) {
        UNSAFE.putInt(null, struct + XGravityEvent.Y, value);
    }
    ...
    public static class Buffer extends StructBuffer<XGravityEvent, Buffer> implements NativeResource {
        ...
        public Buffer type(int value) {
            XGravityEvent.ntype(address(), value);
            return this;
        }
        ...
        public Buffer serial(@NativeType("unsigned long") long value) {
            XGravityEvent.nserial(address(), value);
            return this;
        }
        ...
        public Buffer send_event(@NativeType("Bool") boolean value) {
            XGravityEvent.nsend_event(address(), value ? 1 : 0);
            return this;
        }
        ...
        public Buffer display(@NativeType("Display *") long value) {
            XGravityEvent.ndisplay(address(), value);
            return this;
        }
        ...
        public Buffer event(@NativeType("Window") long value) {
            XGravityEvent.nevent(address(), value);
            return this;
        }
