...
public class CGEventTapInformation extends Struct implements NativeResource {
    ...
    public static int neventTapID(long struct) {
        return UNSAFE.getInt(null, struct + CGEventTapInformation.EVENTTAPID);
    }
    ...
    public static int ntapPoint(long struct) {
        return UNSAFE.getInt(null, struct + CGEventTapInformation.TAPPOINT);
    }
    ...
    public static int noptions(long struct) {
        return UNSAFE.getInt(null, struct + CGEventTapInformation.OPTIONS);
    }
    ...
    public static long neventsOfInterest(long struct) {
        return UNSAFE.getLong(null, struct + CGEventTapInformation.EVENTSOFINTEREST);
    }
    ...
    public static long ntappingProcess(long struct) {
        return memGetAddress(struct + CGEventTapInformation.TAPPINGPROCESS);
    }
    ...
    public static long nprocessBeingTapped(long struct) {
        return memGetAddress(struct + CGEventTapInformation.PROCESSBEINGTAPPED);
    }
    ...
    public static boolean nenabled(long struct) {
        return UNSAFE.getByte(null, struct + CGEventTapInformation.ENABLED) != 0;
    }
    ...
    public static float nminUsecLatency(long struct) {
        return UNSAFE.getFloat(null, struct + CGEventTapInformation.MINUSECLATENCY);
    }
    ...
    public static float navgUsecLatency(long struct) {
        return UNSAFE.getFloat(null, struct + CGEventTapInformation.AVGUSECLATENCY);
    }
    ...
    public static float nmaxUsecLatency(long struct) {
        return UNSAFE.getFloat(null, struct + CGEventTapInformation.MAXUSECLATENCY);
    }
