...
public class ExtentHooks extends Struct implements NativeResource {
    ...
    public static ExtentAlloc nalloc(long struct) {
        return ExtentAlloc.create(memGetAddress(struct + ExtentHooks.ALLOC));
    }
    ...
    public static ExtentDalloc ndalloc(long struct) {
        return ExtentDalloc.createSafe(memGetAddress(struct + ExtentHooks.DALLOC));
    }
    ...
    public static ExtentDestroy ndestroy(long struct) {
        return ExtentDestroy.createSafe(memGetAddress(struct + ExtentHooks.DESTROY));
    }
    ...
    public static ExtentCommit ncommit(long struct) {
        return ExtentCommit.createSafe(memGetAddress(struct + ExtentHooks.COMMIT));
    }
    ...
    public static ExtentDecommit ndecommit(long struct) {
        return ExtentDecommit.createSafe(memGetAddress(struct + ExtentHooks.DECOMMIT));
    }
    ...
    public static ExtentPurge npurge_lazy(long struct) {
        return ExtentPurge.createSafe(memGetAddress(struct + ExtentHooks.PURGE_LAZY));
    }
    ...
    public static ExtentPurge npurge_forced(long struct) {
        return ExtentPurge.createSafe(memGetAddress(struct + ExtentHooks.PURGE_FORCED));
    }
    ...
    public static ExtentSplit nsplit(long struct) {
        return ExtentSplit.createSafe(memGetAddress(struct + ExtentHooks.SPLIT));
    }
    ...
    public static ExtentMerge nmerge(long struct) {
        return ExtentMerge.createSafe(memGetAddress(struct + ExtentHooks.MERGE));
    }
    ...
    public static void nalloc(long struct, ExtentAllocI value) {
        memPutAddress(struct + ExtentHooks.ALLOC, value.address());
    }
    ...
    public static void ndalloc(long struct, @Nullable ExtentDallocI value) {
        memPutAddress(struct + ExtentHooks.DALLOC, memAddressSafe(value));
    }
    ...
    public static void ndestroy(long struct, @Nullable ExtentDestroyI value) {
        memPutAddress(struct + ExtentHooks.DESTROY, memAddressSafe(value));
    }
    ...
    public static void ncommit(long struct, @Nullable ExtentCommitI value) {
        memPutAddress(struct + ExtentHooks.COMMIT, memAddressSafe(value));
    }
    ...
    public static void ndecommit(long struct, @Nullable ExtentDecommitI value) {
        memPutAddress(struct + ExtentHooks.DECOMMIT, memAddressSafe(value));
    }
    ...
    public static void npurge_lazy(long struct, @Nullable ExtentPurgeI value) {
        memPutAddress(struct + ExtentHooks.PURGE_LAZY, memAddressSafe(value));
    }
    ...
    public static void npurge_forced(long struct, @Nullable ExtentPurgeI value) {
        memPutAddress(struct + ExtentHooks.PURGE_FORCED, memAddressSafe(value));
    }
    ...
    public static void nsplit(long struct, @Nullable ExtentSplitI value) {
        memPutAddress(struct + ExtentHooks.SPLIT, memAddressSafe(value));
    }
