...
public class TOUCHINPUT extends Struct implements NativeResource {
    ...
    public static int nx(long struct) {
        return UNSAFE.getInt(null, struct + TOUCHINPUT.X);
    }
    ...
    public static int ny(long struct) {
        return UNSAFE.getInt(null, struct + TOUCHINPUT.Y);
    }
    ...
    public static long nhSource(long struct) {
        return memGetAddress(struct + TOUCHINPUT.HSOURCE);
    }
    ...
    public static int ndwID(long struct) {
        return UNSAFE.getInt(null, struct + TOUCHINPUT.DWID);
    }
    ...
    public static int ndwFlags(long struct) {
        return UNSAFE.getInt(null, struct + TOUCHINPUT.DWFLAGS);
    }
    ...
    public static int ndwMask(long struct) {
        return UNSAFE.getInt(null, struct + TOUCHINPUT.DWMASK);
    }
    ...
    public static int ndwTime(long struct) {
        return UNSAFE.getInt(null, struct + TOUCHINPUT.DWTIME);
    }
    ...
    public static long ndwExtraInfo(long struct) {
        return memGetAddress(struct + TOUCHINPUT.DWEXTRAINFO);
    }
    ...
    public static int ncxContact(long struct) {
        return UNSAFE.getInt(null, struct + TOUCHINPUT.CXCONTACT);
    }
    ...
    public static int ncyContact(long struct) {
        return UNSAFE.getInt(null, struct + TOUCHINPUT.CYCONTACT);
    }
