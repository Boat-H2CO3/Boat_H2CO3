...
public class GLFWVidMode extends Struct {
    ...
    public static int nwidth(long struct) {
        return UNSAFE.getInt(null, struct + GLFWVidMode.WIDTH);
    }
    ...
    public static int nheight(long struct) {
        return UNSAFE.getInt(null, struct + GLFWVidMode.HEIGHT);
    }
    ...
    public static int nredBits(long struct) {
        return UNSAFE.getInt(null, struct + GLFWVidMode.REDBITS);
    }
    ...
    public static int ngreenBits(long struct) {
        return UNSAFE.getInt(null, struct + GLFWVidMode.GREENBITS);
    }
    ...
    public static int nblueBits(long struct) {
        return UNSAFE.getInt(null, struct + GLFWVidMode.BLUEBITS);
    }
    ...
    public static int nrefreshRate(long struct) {
        return UNSAFE.getInt(null, struct + GLFWVidMode.REFRESHRATE);
    }
