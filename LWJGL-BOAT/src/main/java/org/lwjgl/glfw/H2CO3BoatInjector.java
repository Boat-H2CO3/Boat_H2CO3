...
public class H2CO3BoatInjector {
    ...
    public static void setClassLoader(ClassLoader classLoader) {
        String prop = System.getProperty("h2co3_boat.injector");
        if (!get && prop != null && !prop.isEmpty()) {
            H2CO3BoatInjector.classLoader = classLoader;
    ...
    public static void setup(int level, String param0, String param1, String param2, String param3) {
        H2CO3BoatInjector.level = level;
        H2CO3BoatInjector.param0 = param0;
        H2CO3BoatInjector.param1 = param1;
        H2CO3BoatInjector.param2 = param2;
        H2CO3BoatInjector.param3 = param3;
        get = true;
        new Thread(() -> {
            while (true) {
    ...
    public static void nglfwSetHitResultType(String type) {
        ...
        JNI.invokeV(typeInt, H2CO3BoatInjector.SetHitResultType);
    }
