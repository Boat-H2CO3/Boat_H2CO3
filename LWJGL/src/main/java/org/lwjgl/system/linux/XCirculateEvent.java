...
public class XCirculateEvent extends Struct implements NativeResource {
    ...
    public static int ntype(long struct) {
        return UNSAFE.getInt(null, struct + XCirculateEvent.TYPE);
    }
    ...
    public static long nserial(long struct) {
        return memGetCLong(struct + XCirculateEvent.SERIAL);
    }
    ...
    public static int nsend_event(long struct) {
        return UNSAFE.getInt(null, struct + XCirculateEvent.SEND_EVENT);
    }
    ...
    public static long ndisplay(long struct) {
        return memGetAddress(struct + XCirculateEvent.DISPLAY);
    }
    ...
    public static long nevent(long struct) {
        return memGetCLong(struct + XCirculateEvent.EVENT);
    }
    ...
    public static long nwindow(long struct) {
        return memGetCLong(struct + XCirculateEvent.WINDOW);
    }
    ...
    public static int nplace(long struct) {
        return UNSAFE.getInt(null, struct + XCirculateEvent.PLACE);
    }
    ...
    public static void ntype(long struct, int value) {
        UNSAFE.putInt(null, struct + XCirculateEvent.TYPE, value);
    }
    ...
    public static void nserial(long struct, long value) {
        memPutCLong(struct + XCirculateEvent.SERIAL, value);
    }
    ...
    public static void nsend_event(long struct, int value) {
        UNSAFE.putInt(null, struct + XCirculateEvent.SEND_EVENT, value);
    }
    ...
    public static void ndisplay(long struct, long value) {
        memPutAddress(struct + XCirculateEvent.DISPLAY, check(value));
    }
    ...
    public static void nevent(long struct, long value) {
        memPutCLong(struct + XCirculateEvent.EVENT, value);
    }
    ...
    public static void nwindow(long struct, long value) {
        memPutCLong(struct + XCirculateEvent.WINDOW, value);
    }
    ...
    public static void nplace(long struct, int value) {
        UNSAFE.putInt(null, struct + XCirculateEvent.PLACE, value);
    }
    ...
    public static class Buffer extends StructBuffer<XCirculateEvent, Buffer> implements NativeResource {
        ...
        public Buffer type(int value) {
            XCirculateEvent.ntype(address(), value);
            return this;
        }
        ...
        public Buffer serial(@NativeType("unsigned long") long value) {
            XCirculateEvent.nserial(address(), value);
            return this;
        }
        ...
        public Buffer send_event(@NativeType("Bool") boolean value) {
            XCirculateEvent.nsend_event(address(), value ? 1 : 0);
            return this;
        }
        ...
        public Buffer display(@NativeType("Display *") long value) {
            XCirculateEvent.ndisplay(address(), value);
            return this;
        }
        ...
        public Buffer event(@NativeType("Window") long value) {
            XCirculateEvent.nevent(address(), value);
            return this;
        }
        ...
        public Buffer window(@NativeType("Window") long value) {
            XCirculateEvent.nwindow(address(), value);
            return this;
        }
        ...
        public Buffer place(int value) {
            XCirculateEvent.nplace(address(), value);
            return this;
        }
