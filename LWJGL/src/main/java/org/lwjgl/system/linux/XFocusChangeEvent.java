...
public class XFocusChangeEvent extends Struct implements NativeResource {
    ...
    public static int ntype(long struct) {
        return UNSAFE.getInt(null, struct + XFocusChangeEvent.TYPE);
    }
    ...
    public static long nserial(long struct) {
        return memGetCLong(struct + XFocusChangeEvent.SERIAL);
    }
    ...
    public static int nsend_event(long struct) {
        return UNSAFE.getInt(null, struct + XFocusChangeEvent.SEND_EVENT);
    }
    ...
    public static long ndisplay(long struct) {
        return memGetAddress(struct + XFocusChangeEvent.DISPLAY);
    }
    ...
    public static long nwindow(long struct) {
        return memGetCLong(struct + XFocusChangeEvent.WINDOW);
    }
    ...
    public static int nmode(long struct) {
        return UNSAFE.getInt(null, struct + XFocusChangeEvent.MODE);
    }
    ...
    public static int ndetail(long struct) {
        return UNSAFE.getInt(null, struct + XFocusChangeEvent.DETAIL);
    }
    ...
    public static void ntype(long struct, int value) {
        UNSAFE.putInt(null, struct + XFocusChangeEvent.TYPE, value);
    }
    ...
    public static void nserial(long struct, long value) {
        memPutCLong(struct + XFocusChangeEvent.SERIAL, value);
    }
    ...
    public static void nsend_event(long struct, int value) {
        UNSAFE.putInt(null, struct + XFocusChangeEvent.SEND_EVENT, value);
    }
    ...
    public static void ndisplay(long struct, long value) {
        memPutAddress(struct + XFocusChangeEvent.DISPLAY, check(value));
    }
    ...
    public static void nwindow(long struct, long value) {
        memPutCLong(struct + XFocusChangeEvent.WINDOW, value);
    }
    ...
    public static void nmode(long struct, int value) {
        UNSAFE.putInt(null, struct + XFocusChangeEvent.MODE, value);
    }
    ...
    public static void ndetail(long struct, int value) {
        UNSAFE.putInt(null, struct + XFocusChangeEvent.DETAIL, value);
    }
    ...
    public static class Buffer extends StructBuffer<XFocusChangeEvent, Buffer> implements NativeResource {
        ...
        public Buffer type(int value) {
            XFocusChangeEvent.ntype(address(), value);
            return this;
        }
        ...
        public Buffer serial(@NativeType("unsigned long") long value) {
            XFocusChangeEvent.nserial(address(), value);
            return this;
        }
        ...
        public Buffer send_event(@NativeType("Bool") boolean value) {
            XFocusChangeEvent.nsend_event(address(), value ? 1 : 0);
            return this;
        }
        ...
        public Buffer display(@NativeType("Display *") long value) {
            XFocusChangeEvent.ndisplay(address(), value);
            return this;
        }
        ...
        public Buffer window(@NativeType("Window") long value) {
            XFocusChangeEvent.nwindow(address(), value);
            return this;
        }
        ...
        public Buffer mode(int value) {
            XFocusChangeEvent.nmode(address(), value);
            return this;
        }
        ...
        public Buffer detail(int value) {
            XFocusChangeEvent.ndetail(address(), value);
            return this;
        }
