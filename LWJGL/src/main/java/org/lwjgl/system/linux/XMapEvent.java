...
public class XMapEvent extends Struct implements NativeResource {
    ...
    public static int ntype(long struct) {
        return UNSAFE.getInt(null, struct + XMapEvent.TYPE);
    }
    ...
    public static long nserial(long struct) {
        return memGetCLong(struct + XMapEvent.SERIAL);
    }
    ...
    public static int nsend_event(long struct) {
        return UNSAFE.getInt(null, struct + XMapEvent.SEND_EVENT);
    }
    ...
    public static long ndisplay(long struct) {
        return memGetAddress(struct + XMapEvent.DISPLAY);
    }
    ...
    public static long nevent(long struct) {
        return memGetCLong(struct + XMapEvent.EVENT);
    }
    ...
    public static long nwindow(long struct) {
        return memGetCLong(struct + XMapEvent.WINDOW);
    }
    ...
    public static int noverride_redirect(long struct) {
        return UNSAFE.getInt(null, struct + XMapEvent.OVERRIDE_REDIRECT);
    }
    ...
    public static void ntype(long struct, int value) {
        UNSAFE.putInt(null, struct + XMapEvent.TYPE, value);
    }
    ...
    public static void nserial(long struct, long value) {
        memPutCLong(struct + XMapEvent.SERIAL, value);
    }
    ...
    public static void nsend_event(long struct, int value) {
        UNSAFE.putInt(null, struct + XMapEvent.SEND_EVENT, value);
    }
    ...
    public static void ndisplay(long struct, long value) {
        memPutAddress(struct + XMapEvent.DISPLAY, check(value));
    }
    ...
    public static void nevent(long struct, long value) {
        memPutCLong(struct + XMapEvent.EVENT, value);
    }
    ...
    public static void nwindow(long struct, long value) {
        memPutCLong(struct + XMapEvent.WINDOW, value);
    }
    ...
    public static void noverride_redirect(long struct, int value) {
        UNSAFE.putInt(null, struct + XMapEvent.OVERRIDE_REDIRECT, value);
    }
    ...
    public static class Buffer extends StructBuffer<XMapEvent, Buffer> implements NativeResource {
        ...
        public Buffer serial(@NativeType("unsigned long") long value) {
            XMapEvent.nserial(address(), value);
            return this;
        }
        ...
        public Buffer send_event(@NativeType("Bool") boolean value) {
            XMapEvent.nsend_event(address(), value ? 1 : 0);
            return this;
        }
        ...
        public Buffer display(@NativeType("Display *") long value) {
            XMapEvent.ndisplay(address(), value);
            return this;
        }
        ...
        public Buffer event(@NativeType("Window") long value) {
            XMapEvent.nevent(address(), value);
            return this;
        }
        ...
        public Buffer window(@NativeType("Window") long value) {
            XMapEvent.nwindow(address(), value);
            return this;
        }
        ...
        public Buffer override_redirect(int value) {
            XMapEvent.noverride_redirect(address(), value);
            return this;
        }
