...
public class XSelectionClearEvent extends Struct implements NativeResource {
    ...
    public static int ntype(long struct) {
        return UNSAFE.getInt(null, struct + XSelectionClearEvent.TYPE);
    }
    ...
    public static long nserial(long struct) {
        return memGetCLong(struct + XSelectionClearEvent.SERIAL);
    }
    ...
    public static int nsend_event(long struct) {
        return UNSAFE.getInt(null, struct + XSelectionClearEvent.SEND_EVENT);
    }
    ...
    public static long ndisplay(long struct) {
        return memGetAddress(struct + XSelectionClearEvent.DISPLAY);
    }
    ...
    public static long nwindow(long struct) {
        return memGetCLong(struct + XSelectionClearEvent.WINDOW);
    }
    ...
    public static long nselection(long struct) {
        return memGetCLong(struct + XSelectionClearEvent.SELECTION);
    }
    ...
    public static long ntime(long struct) {
        return memGetCLong(struct + XSelectionClearEvent.TIME);
    }
    ...
    public static void ntype(long struct, int value) {
        UNSAFE.putInt(null, struct + XSelectionClearEvent.TYPE, value);
    }
    ...
    public static void nserial(long struct, long value) {
        memPutCLong(struct + XSelectionClearEvent.SERIAL, value);
    }
    ...
    public static void nsend_event(long struct, int value) {
        UNSAFE.putInt(null, struct + XSelectionClearEvent.SEND_EVENT, value);
    }
    ...
    public static void ndisplay(long struct, long value) {
        memPutAddress(struct + XSelectionClearEvent.DISPLAY, check(value));
    }
    ...
    public static void nwindow(long struct, long value) {
        memPutCLong(struct + XSelectionClearEvent.WINDOW, value);
    }
    ...
    public static void nselection(long struct, long value) {
        memPutCLong(struct + XSelectionClearEvent.SELECTION, value);
    }
    ...
    public static void ntime(long struct, long value) {
        memPutCLong(struct + XSelectionClearEvent.TIME, value);
    }
    ...
    public static class Buffer extends StructBuffer<XSelectionClearEvent, Buffer> implements NativeResource {
        ...
        public Buffer type(int value) {
            XSelectionClearEvent.ntype(address(), value);
            return this;
        }
        ...
        public Buffer serial(@NativeType("unsigned long") long value) {
            XSelectionClearEvent.nserial(address(), value);
            return this;
        }
        ...
        public Buffer send_event(@NativeType("Bool") boolean value) {
            XSelectionClearEvent.nsend_event(address(), value ? 1 : 0);
            return this;
        }
        ...
        public Buffer display(@NativeType("Display *") long value) {
            XSelectionClearEvent.ndisplay(address(), value);
            return this;
        }
        ...
        public Buffer window(@NativeType("Window") long value) {
            XSelectionClearEvent.nwindow(address(), value);
            return this;
        }
