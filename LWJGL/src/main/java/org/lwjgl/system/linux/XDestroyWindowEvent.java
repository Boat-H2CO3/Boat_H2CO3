...
public class XDestroyWindowEvent extends Struct implements NativeResource {
    ...
    public static int ntype(long struct) {
        return UNSAFE.getInt(null, struct + XDestroyWindowEvent.TYPE);
    }
    ...
    public static long nserial(long struct) {
        return memGetCLong(struct + XDestroyWindowEvent.SERIAL);
    }
    ...
    public static int nsend_event(long struct) {
        return UNSAFE.getInt(null, struct + XDestroyWindowEvent.SEND_EVENT);
    }
    ...
    public static long ndisplay(long struct) {
        return memGetAddress(struct + XDestroyWindowEvent.DISPLAY);
    }
    ...
    public static long nevent(long struct) {
        return memGetCLong(struct + XDestroyWindowEvent.EVENT);
    }
    ...
    public static long nwindow(long struct) {
        return memGetCLong(struct + XDestroyWindowEvent.WINDOW);
    }
    ...
    public static void ntype(long struct, int value) {
        UNSAFE.putInt(null, struct + XDestroyWindowEvent.TYPE, value);
    }
    ...
    public static void nserial(long struct, long value) {
        memPutCLong(struct + XDestroyWindowEvent.SERIAL, value);
    }
    ...
    public static void nsend_event(long struct, int value) {
        UNSAFE.putInt(null, struct + XDestroyWindowEvent.SEND_EVENT, value);
    }
    ...
    public static void ndisplay(long struct, long value) {
        memPutAddress(struct + XDestroyWindowEvent.DISPLAY, check(value));
    }
    ...
    public static void nevent(long struct, long value) {
        memPutCLong(struct + XDestroyWindowEvent.EVENT, value);
    }
    ...
    public static void nwindow(long struct, long value) {
        memPutCLong(struct + XDestroyWindowEvent.WINDOW, value);
    }
    ...
    public static class Buffer extends StructBuffer<XDestroyWindowEvent, Buffer> implements NativeResource {
        ...
        public Buffer type(int value) {
            XDestroyWindowEvent.ntype(address(), value);
            return this;
        }
        ...
        public Buffer serial(@NativeType("unsigned long") long value) {
            XDestroyWindowEvent.nserial(address(), value);
            return this;
        }
        ...
        public Buffer send_event(@NativeType("Bool") boolean value) {
            XDestroyWindowEvent.nsend_event(address(), value ? 1 : 0);
            return this;
        }
        ...
        public Buffer display(@NativeType("Display *") long value) {
            XDestroyWindowEvent.ndisplay(address(), value);
            return this;
        }
