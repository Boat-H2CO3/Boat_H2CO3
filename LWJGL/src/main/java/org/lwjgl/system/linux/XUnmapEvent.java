...
public class XUnmapEvent extends Struct implements NativeResource {
    ...
    public static int ntype(long struct) {
        return UNSAFE.getInt(null, struct + XUnmapEvent.TYPE);
    }
    ...
    public static long nserial(long struct) {
        return memGetCLong(struct + XUnmapEvent.SERIAL);
    }
    ...
    public static int nsend_event(long struct) {
        return UNSAFE.getInt(null, struct + XUnmapEvent.SEND_EVENT);
    }
    ...
    public static long ndisplay(long struct) {
        return memGetAddress(struct + XUnmapEvent.DISPLAY);
    }
    ...
    public static long nevent(long struct) {
        return memGetCLong(struct + XUnmapEvent.EVENT);
    }
    ...
    public static long nwindow(long struct) {
        return memGetCLong(struct + XUnmapEvent.WINDOW);
    }
    ...
    public static int nfrom_configure(long struct) {
        return UNSAFE.getInt(null, struct + XUnmapEvent.FROM_CONFIGURE);
    }
    ...
    public static void ntype(long struct, int value) {
        UNSAFE.putInt(null, struct + XUnmapEvent.TYPE, value);
    }
    ...
    public static void nserial(long struct, long value) {
        memPutCLong(struct + XUnmapEvent.SERIAL, value);
    }
    ...
    public static void nsend_event(long struct, int value) {
        UNSAFE.putInt(null, struct + XUnmapEvent.SEND_EVENT, value);
    }
    ...
    public static void ndisplay(long struct, long value) {
        memPutAddress(struct + XUnmapEvent.DISPLAY, check(value));
    }
    ...
    public static void nevent(long struct, long value) {
        memPutCLong(struct + XUnmapEvent.EVENT, value);
    }
    ...
    public static void nwindow(long struct, long value) {
        memPutCLong(struct + XUnmapEvent.WINDOW, value);
    }
    ...
    public static void nfrom_configure(long struct, int value) {
        UNSAFE.putInt(null, struct + XUnmapEvent.FROM_CONFIGURE, value);
    }
    ...
    public static class Buffer extends StructBuffer<XUnmapEvent, Buffer> implements NativeResource {
        ...
        public Buffer type(int value) {
            XUnmapEvent.ntype(address(), value);
            return this;
        }
        ...
        public Buffer serial(@NativeType("unsigned long") long value) {
            XUnmapEvent.nserial(address(), value);
            return this;
        }
        ...
        public Buffer send_event(@NativeType("Bool") boolean value) {
            XUnmapEvent.nsend_event(address(), value ? 1 : 0);
            return this;
        }
        ...
        public Buffer display(@NativeType("Display *") long value) {
            XUnmapEvent.ndisplay(address(), value);
            return this;
        }
        ...
        public Buffer event(@NativeType("Window") long value) {
            XUnmapEvent.nevent(address(), value);
            return this;
        }
        ...
        public Buffer window(@NativeType("Window") long value) {
            XUnmapEvent.nwindow(address(), value);
            return this;
        }
        ...
        public Buffer from_configure(int value) {
            XUnmapEvent.nfrom_configure(address(), value);
            return this;
        }
