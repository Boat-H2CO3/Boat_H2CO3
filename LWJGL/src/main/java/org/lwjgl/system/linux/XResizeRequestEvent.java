...
public class XResizeRequestEvent extends Struct implements NativeResource {
    ...
    public static int ntype(long struct) {
        return UNSAFE.getInt(null, struct + XResizeRequestEvent.TYPE);
    }
    ...
    public static long nserial(long struct) {
        return memGetCLong(struct + XResizeRequestEvent.SERIAL);
    }
    ...
    public static int nsend_event(long struct) {
        return UNSAFE.getInt(null, struct + XResizeRequestEvent.SEND_EVENT);
    }
    ...
    public static long ndisplay(long struct) {
        return memGetAddress(struct + XResizeRequestEvent.DISPLAY);
    }
    ...
    public static long nwindow(long struct) {
        return memGetCLong(struct + XResizeRequestEvent.WINDOW);
    }
    ...
    public static int nwidth(long struct) {
        return UNSAFE.getInt(null, struct + XResizeRequestEvent.WIDTH);
    }
    ...
    public static int nheight(long struct) {
        return UNSAFE.getInt(null, struct + XResizeRequestEvent.HEIGHT);
    }
    ...
    public static void ntype(long struct, int value) {
        UNSAFE.putInt(null, struct + XResizeRequestEvent.TYPE, value);
    }
    ...
    public static void nserial(long struct, long value) {
        memPutCLong(struct + XResizeRequestEvent.SERIAL, value);
    }
    ...
    public static void nsend_event(long struct, int value) {
        UNSAFE.putInt(null, struct + XResizeRequestEvent.SEND_EVENT, value);
    }
    ...
    public static void ndisplay(long struct, long value) {
        memPutAddress(struct + XResizeRequestEvent.DISPLAY, check(value));
    }
    ...
    public static void nwindow(long struct, long value) {
        memPutCLong(struct + XResizeRequestEvent.WINDOW, value);
    }
    ...
    public static void nwidth(long struct, int value) {
        UNSAFE.putInt(null, struct + XResizeRequestEvent.WIDTH, value);
    }
    ...
    public static void nheight(long struct, int value) {
        UNSAFE.putInt(null, struct + XResizeRequestEvent.HEIGHT, value);
    }
    ...
    public static class Buffer extends StructBuffer<XResizeRequestEvent, Buffer> implements NativeResource {
        ...
        public Buffer type(int value) {
            XResizeRequestEvent.ntype(address(), value);
            return this;
        }
        ...
        public Buffer serial(@NativeType("unsigned long") long value) {
            XResizeRequestEvent.nserial(address(), value);
            return this;
        }
        ...
        public Buffer send_event(@NativeType("Bool") boolean value) {
            XResizeRequestEvent.nsend_event(address(), value ? 1 : 0);
            return this;
        }
        ...
        public Buffer display(@NativeType("Display *") long value) {
            XResizeRequestEvent.ndisplay(address(), value);
            return this;
        }
        ...
        public Buffer window(@NativeType("Window") long value) {
            XResizeRequestEvent.nwindow(address(), value);
            return this;
        }
        ...
        public Buffer width(int value) {
            XResizeRequestEvent.nwidth(address(), value);
            return this;
        }
        ...
        public Buffer height(int value) {
            XResizeRequestEvent.nheight(address(), value);
            return this;
        }
