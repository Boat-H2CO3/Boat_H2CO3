...
public class XPropertyEvent extends Struct implements NativeResource {
    ...
    public static int ntype(long struct) {
        return UNSAFE.getInt(null, struct + XPropertyEvent.TYPE);
    }
    ...
    public static long nserial(long struct) {
        return memGetCLong(struct + XPropertyEvent.SERIAL);
    }
    ...
    public static int nsend_event(long struct) {
        return UNSAFE.getInt(null, struct + XPropertyEvent.SEND_EVENT);
    }
    ...
    public static long ndisplay(long struct) {
        return memGetAddress(struct + XPropertyEvent.DISPLAY);
    }
    ...
    public static long nwindow(long struct) {
        return memGetCLong(struct + XPropertyEvent.WINDOW);
    }
    ...
    public static long natom(long struct) {
        return memGetCLong(struct + XPropertyEvent.ATOM);
    }
    ...
    public static long ntime(long struct) {
        return memGetCLong(struct + XPropertyEvent.TIME);
    }
    ...
    public static int nstate(long struct) {
        return UNSAFE.getInt(null, struct + XPropertyEvent.STATE);
    }
    ...
    public static void ntype(long struct, int value) {
        UNSAFE.putInt(null, struct + XPropertyEvent.TYPE, value);
    }
    ...
    public static void nserial(long struct, long value) {
        memPutCLong(struct + XPropertyEvent.SERIAL, value);
    }
    ...
    public static void nsend_event(long struct, int value) {
        UNSAFE.putInt(null, struct + XPropertyEvent.SEND_EVENT, value);
    }
    ...
    public static void ndisplay(long struct, long value) {
        memPutAddress(struct + XPropertyEvent.DISPLAY, check(value));
    }
    ...
    public static void nwindow(long struct, long value) {
        memPutCLong(struct + XPropertyEvent.WINDOW, value);
    }
    ...
    public static void natom(long struct, long value) {
        memPutCLong(struct + XPropertyEvent.ATOM, value);
    }
    ...
    public static void ntime(long struct, long value) {
        memPutCLong(struct + XPropertyEvent.TIME, value);
    }
    ...
    public static class Buffer extends StructBuffer<XPropertyEvent, Buffer> implements NativeResource {
        ...
        public Buffer type(int value) {
            XPropertyEvent.ntype(address(), value);
            return this;
        }
        ...
        public Buffer serial(@NativeType("unsigned long") long value) {
            XPropertyEvent.nserial(address(), value);
            return this;
        }
        ...
        public Buffer send_event(@NativeType("Bool") boolean value) {
            XPropertyEvent.nsend_event(address(), value ? 1 : 0);
            return this;
        }
        ...
        public Buffer display(@NativeType("Display *") long value) {
            XPropertyEvent.ndisplay(address(), value);
            return this;
        }
        ...
        public Buffer window(@NativeType("Window") long value) {
            XPropertyEvent.nwindow(address(), value);
            return this;
        }
