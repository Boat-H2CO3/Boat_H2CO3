...
public class XGenericEventCookie extends Struct implements NativeResource {
    ...
    public static int ntype(long struct) {
        return UNSAFE.getInt(null, struct + XGenericEventCookie.TYPE);
    }
    ...
    public static long nserial(long struct) {
        return memGetCLong(struct + XGenericEventCookie.SERIAL);
    }
    ...
    public static int nsend_event(long struct) {
        return UNSAFE.getInt(null, struct + XGenericEventCookie.SEND_EVENT);
    }
    ...
    public static long ndisplay(long struct) {
        return memGetAddress(struct + XGenericEventCookie.DISPLAY);
    }
    ...
    public static int nextension(long struct) {
        return UNSAFE.getInt(null, struct + XGenericEventCookie.EXTENSION);
    }
    ...
    public static int nevtype(long struct) {
        return UNSAFE.getInt(null, struct + XGenericEventCookie.EVTYPE);
    }
    ...
    public static int ncookie(long struct) {
        return UNSAFE.getInt(null, struct + XGenericEventCookie.COOKIE);
    }
    ...
    public static ByteBuffer ndata(long struct, int capacity) {
        return memByteBuffer(memGetAddress(struct + XGenericEventCookie.DATA), capacity);
    }
    ...
    public static void ntype(long struct, int value) {
        UNSAFE.putInt(null, struct + XGenericEventCookie.TYPE, value);
    }
    ...
    public static void nserial(long struct, long value) {
        memPutCLong(struct + XGenericEventCookie.SERIAL, value);
    }
    ...
    public static void nsend_event(long struct, int value) {
        UNSAFE.putInt(null, struct + XGenericEventCookie.SEND_EVENT, value);
    }
    ...
    public static void ndisplay(long struct, long value) {
        memPutAddress(struct + XGenericEventCookie.DISPLAY, check(value));
    }
    ...
    public static void nextension(long struct, int value) {
        UNSAFE.putInt(null, struct + XGenericEventCookie.EXTENSION, value);
    }
    ...
    public static void nevtype(long struct, int value) {
        UNSAFE.putInt(null, struct + XGenericEventCookie.EVTYPE, value);
    }
    ...
    public static void ncookie(long struct, int value) {
        UNSAFE.putInt(null, struct + XGenericEventCookie.COOKIE, value);
    }
    ...
    public static void ndata(long struct, ByteBuffer value) {
        memPutAddress(struct + XGenericEventCookie.DATA, memAddress(value));
    }
    ...
    public static class Buffer extends StructBuffer<XGenericEventCookie, Buffer> implements NativeResource {
        ...
        @NativeType("void *")
        public ByteBuffer data(int capacity) {
            return XGenericEventCookie.ndata(address(), capacity);
        }
        ...
        public Buffer type(int value) {
            XGenericEventCookie.ntype(address(), value);
            return this;
        }
        ...
        public Buffer serial(@NativeType("unsigned long") long value) {
            XGenericEventCookie.nserial(address(), value);
            return this;
        }
        ...
        public Buffer send_event(@NativeType("Bool") boolean value) {
            XGenericEventCookie.nsend_event(address(), value ? 1 : 0);
            return this;
        }
        ...
        public Buffer display(@NativeType("Display *") long value) {
            XGenericEventCookie.ndisplay(address(), value);
            return this;
        }
        ...
        public Buffer extension(int value) {
            XGenericEventCookie.nextension(address(), value);
            return this;
        }
        ...
        public Buffer evtype(int value) {
            XGenericEventCookie.nevtype(address(), value);
            return this;
        }
        ...
        public Buffer cookie(@NativeType("unsigned int") int value) {
            XGenericEventCookie.ncookie(address(), value);
            return this;
        }
        ...
        public Buffer data(@NativeType("void *") ByteBuffer value) {
            XGenericEventCookie.ndata(address(), value);
            return this;
        }
