...
public class XMapRequestEvent extends Struct implements NativeResource {
    ...
    public static int ntype(long struct) {
        return UNSAFE.getInt(null, struct + XMapRequestEvent.TYPE);
    }
    ...
    public static long nserial(long struct) {
        return memGetCLong(struct + XMapRequestEvent.SERIAL);
    }
    ...
    public static int nsend_event(long struct) {
        return UNSAFE.getInt(null, struct + XMapRequestEvent.SEND_EVENT);
    }
    ...
    public static long ndisplay(long struct) {
        return memGetAddress(struct + XMapRequestEvent.DISPLAY);
    }
    ...
    public static long nparent(long struct) {
        return memGetCLong(struct + XMapRequestEvent.PARENT);
    }
    ...
    public static long nwindow(long struct) {
        return memGetCLong(struct + XMapRequestEvent.WINDOW);
    }
    ...
    public static void ntype(long struct, int value) {
        UNSAFE.putInt(null, struct + XMapRequestEvent.TYPE, value);
    }
    ...
    public static void nserial(long struct, long value) {
        memPutCLong(struct + XMapRequestEvent.SERIAL, value);
    }
    ...
    public static void nsend_event(long struct, int value) {
        UNSAFE.putInt(null, struct + XMapRequestEvent.SEND_EVENT, value);
    }
    ...
    public static void ndisplay(long struct, long value) {
        memPutAddress(struct + XMapRequestEvent.DISPLAY, check(value));
    }
    ...
    public static void nparent(long struct, long value) {
        memPutCLong(struct + XMapRequestEvent.PARENT, value);
    }
    ...
    public static void nwindow(long struct, long value) {
        memPutCLong(struct + XMapRequestEvent.WINDOW, value);
    }
    ...
    public static class Buffer extends StructBuffer<XMapRequestEvent, Buffer> implements NativeResource {
        ...
        public Buffer type(int value) {
            XMapRequestEvent.ntype(address(), value);
            return this;
        }
        ...
        public Buffer serial(@NativeType("unsigned long") long value) {
            XMapRequestEvent.nserial(address(), value);
            return this;
        }
        ...
        public Buffer send_event(@NativeType("Bool") boolean value) {
            XMapRequestEvent.nsend_event(address(), value ? 1 : 0);
            return this;
        }
        ...
        public Buffer display(@NativeType("Display *") long value) {
            XMapRequestEvent.ndisplay(address(), value);
            return this;
        }
        ...
        public Buffer parent(@NativeType("Window") long value) {
            XMapRequestEvent.nparent(address(), value);
            return this;
        }
        ...
        public Buffer window(@NativeType("Window") long value) {
            XMapRequestEvent.nwindow(address(), value);
            return this;
        }
