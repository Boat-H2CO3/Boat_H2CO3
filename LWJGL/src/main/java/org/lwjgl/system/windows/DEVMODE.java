...
public class DEVMODE extends Struct implements NativeResource {
    ...
    public static short ndmSize(long struct) {
        return UNSAFE.getShort(null, struct + DEVMODE.DMSIZE);
    }
    ...
    public static int ndmFields(long struct) {
        return UNSAFE.getInt(null, struct + DEVMODE.DMFIELDS);
    }
    ...
    public static int ndmDisplayOrientation(long struct) {
        return UNSAFE.getInt(null, struct + DEVMODE.DMDISPLAYORIENTATION);
    }
    ...
    public static int ndmDisplayFixedOutput(long struct) {
        return UNSAFE.getInt(null, struct + DEVMODE.DMDISPLAYFIXEDOUTPUT);
    }
    ...
    public static int ndmBitsPerPel(long struct) {
        return UNSAFE.getInt(null, struct + DEVMODE.DMBITSPERPEL);
    }
    ...
    public static int ndmPelsWidth(long struct) {
        return UNSAFE.getInt(null, struct + DEVMODE.DMPELSWIDTH);
    }
    ...
    public static int ndmPelsHeight(long struct) {
        return UNSAFE.getInt(null, struct + DEVMODE.DMPELSHEIGHT);
    }
    ...
    public static int ndmDisplayFlags(long struct) {
        return UNSAFE.getInt(null, struct + DEVMODE.DMDISPLAYFLAGS);
    }
    ...
    public static int ndmNup(long struct) {
        return UNSAFE.getInt(null, struct + DEVMODE.DMNUP);
    }
    ...
    public static int ndmDisplayFrequency(long struct) {
        return UNSAFE.getInt(null, struct + DEVMODE.DMDISPLAYFREQUENCY);
    }
    ...
    public static int ndmICMMethod(long struct) {
        return UNSAFE.getInt(null, struct + DEVMODE.DMICMMETHOD);
    }
    ...
    public static int ndmICMIntent(long struct) {
        return UNSAFE.getInt(null, struct + DEVMODE.DMICMINTENT);
    }
    ...
    public static int ndmMediaType(long struct) {
        return UNSAFE.getInt(null, struct + DEVMODE.DMMEDIATYPE);
    }
    ...
    public static int ndmDitherType(long struct) {
        return UNSAFE.getInt(null, struct + DEVMODE.DMDITHERTYPE);
    }
    ...
    public static int ndmPanningWidth(long struct) {
        return UNSAFE.getInt(null, struct + DEVMODE.DMPANNINGWIDTH);
    }
    ...
    public static int ndmPanningHeight(long struct) {
        return UNSAFE.getInt(null, struct + DEVMODE.DMPANNINGHEIGHT);
    }
