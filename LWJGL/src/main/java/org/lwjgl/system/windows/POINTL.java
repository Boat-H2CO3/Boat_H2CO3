...
public class POINTL extends Struct implements NativeResource {
    ...
    public static int nx(long struct) {
        return UNSAFE.getInt(null, struct + POINTL.X);
    }
    ...
    public static int ny(long struct) {
        return UNSAFE.getInt(null, struct + POINTL.Y);
    }
    ...
    public static void nx(long struct, int value) {
        UNSAFE.putInt(null, struct + POINTL.X, value);
    }
    ...
    public static void ny(long struct, int value) {
        UNSAFE.putInt(null, struct + POINTL.Y, value);
    }
