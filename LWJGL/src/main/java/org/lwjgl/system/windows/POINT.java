...
public class POINT extends Struct implements NativeResource {
    ...
    public static int nx(long struct) {
        return UNSAFE.getInt(null, struct + POINT.X);
    }
    ...
    public static int ny(long struct) {
        return UNSAFE.getInt(null, struct + POINT.Y);
    }
    ...
    public static void nx(long struct, int value) {
        UNSAFE.putInt(null, struct + POINT.X, value);
    }
    ...
    public static void ny(long struct, int value) {
        UNSAFE.putInt(null, struct + POINT.Y, value);
    }
