...
public class STBRPContext extends Struct implements NativeResource {
    ...
    public static int nwidth(long struct) {
        return UNSAFE.getInt(null, struct + STBRPContext.WIDTH);
    }
    ...
    public static int nheight(long struct) {
        return UNSAFE.getInt(null, struct + STBRPContext.HEIGHT);
    }
    ...
    public static int nalign(long struct) {
        return UNSAFE.getInt(null, struct + STBRPContext.ALIGN);
    }
    ...
    public static int ninit_mode(long struct) {
        return UNSAFE.getInt(null, struct + STBRPContext.INIT_MODE);
    }
    ...
    public static int nheuristic(long struct) {
        return UNSAFE.getInt(null, struct + STBRPContext.HEURISTIC);
    }
    ...
    public static int nnum_nodes(long struct) {
        return UNSAFE.getInt(null, struct + STBRPContext.NUM_NODES);
    }
    ...
    public static STBRPNode nactive_head(long struct) {
        return STBRPNode.createSafe(memGetAddress(struct + STBRPContext.ACTIVE_HEAD));
    }
    ...
    public static STBRPNode nfree_head(long struct) {
        return STBRPNode.createSafe(memGetAddress(struct + STBRPContext.FREE_HEAD));
    }
    ...
    public static STBRPNode.Buffer nextra(long struct) {
        return STBRPNode.create(struct + STBRPContext.EXTRA, 2);
    }
    ...
    public static class Buffer extends StructBuffer<STBRPContext, Buffer> implements NativeResource {
        ...
        @NativeType("stbrp_node")
        public STBRPNode extra(int index) {
            return STBRPContext.nextra(address(), index);
        }
