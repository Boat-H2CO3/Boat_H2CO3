...
public class STBRPRect extends Struct implements NativeResource {
     ...
     */
    public STBRPRect w(@NativeType("stbrp_coord") short value) {
        nw(address(), value);
        return this;
    }
     ...
     */
    public STBRPRect h(@NativeType("stbrp_coord") short value) {
        nh(address(), value);
        return this;
    }
     ...
     */
    public STBRPRect x(@NativeType("stbrp_coord") short value) {
        nx(address(), value);
        return this;
    }
     ...
     */
    public STBRPRect y(@NativeType("stbrp_coord") short value) {
        ny(address(), value);
        return this;
    }
    ...
    public static int nid(long struct) {
        return UNSAFE.getInt(null, struct + STBRPRect.ID);
    }
    ...
    public static short nw(long struct) {
        return UNSAFE.getShort(null, struct + STBRPRect.W);
    }
    ...
    public static short nh(long struct) {
        return UNSAFE.getShort(null, struct + STBRPRect.H);
    }
    ...
    public static short nx(long struct) {
        return UNSAFE.getShort(null, struct + STBRPRect.X);
    }
    ...
    public static short ny(long struct) {
        return UNSAFE.getShort(null, struct + STBRPRect.Y);
    }
    ...
    public static int nwas_packed(long struct) {
        return UNSAFE.getInt(null, struct + STBRPRect.WAS_PACKED);
    }
    ...
    public static void nid(long struct, int value) {
        UNSAFE.putInt(null, struct + STBRPRect.ID, value);
    }
    ...
    public static void nw(long struct, short value) {
        UNSAFE.putShort(null, struct + STBRPRect.W, value);
    }
    ...
    public static void nh(long struct, short value) {
        UNSAFE.putShort(null, struct + STBRPRect.H, value);
    }
    ...
    public static void nx(long struct, short value) {
        UNSAFE.putShort(null, struct + STBRPRect.X, value);
    }
    ...
    public static void ny(long struct, short value) {
        UNSAFE.putShort(null, struct + STBRPRect.Y, value);
    }
    ...
    public static void nwas_packed(long struct, int value) {
        UNSAFE.putInt(null, struct + STBRPRect.WAS_PACKED, value);
    }
    ...
    public static class Buffer extends StructBuffer<STBRPRect, Buffer> implements NativeResource {
         ...
         * Sets the specified value to the {@code w} field.
         */
        public Buffer w(@NativeType("stbrp_coord") short value) {
            STBRPRect.nw(address(), value);
            return this;
        }
         ...
         * Sets the specified value to the {@code h} field.
         */
        public Buffer h(@NativeType("stbrp_coord") short value) {
            STBRPRect.nh(address(), value);
            return this;
        }
         ...
         * Sets the specified value to the {@code x} field.
         */
        public Buffer x(@NativeType("stbrp_coord") short value) {
            STBRPRect.nx(address(), value);
            return this;
        }
