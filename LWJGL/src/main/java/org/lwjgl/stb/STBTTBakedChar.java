...
public class STBTTBakedChar extends Struct implements NativeResource {
    ...
    public static short nx0(long struct) {
        return UNSAFE.getShort(null, struct + STBTTBakedChar.X0);
    }
    ...
    public static short ny0(long struct) {
        return UNSAFE.getShort(null, struct + STBTTBakedChar.Y0);
    }
    ...
    public static short nx1(long struct) {
        return UNSAFE.getShort(null, struct + STBTTBakedChar.X1);
    }
    ...
    public static short ny1(long struct) {
        return UNSAFE.getShort(null, struct + STBTTBakedChar.Y1);
    }
    ...
    public static float nxoff(long struct) {
        return UNSAFE.getFloat(null, struct + STBTTBakedChar.XOFF);
    }
    ...
    public static float nyoff(long struct) {
        return UNSAFE.getFloat(null, struct + STBTTBakedChar.YOFF);
    }
    ...
    public static float nxadvance(long struct) {
        return UNSAFE.getFloat(null, struct + STBTTBakedChar.XADVANCE);
    }
