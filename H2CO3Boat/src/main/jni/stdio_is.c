...
JNIEXPORT jint JNI_OnLoad(JavaVM* vm, __attribute((unused)) void* reserved) {
    ...
    jclass eventLogListener = (*env)->FindClass(env,
                                                "org/koishi/launcher/h2co3/boat/logcat/Logger$eventLogListener");
...
Java_org_koishi_launcher_h2co3_boat_logcat_Logger_begin(JNIEnv *env,
...
JNIEXPORT void JNICALL Java_org_koishi_launcher_h2co3_boat_logcat_Logger_appendToLog(JNIEnv *env,
                                                                                     __attribute((unused)) jclass clazz,
                                                                                     jstring text) {
...
JNIEXPORT void JNICALL
Java_org_koishi_launcher_h2co3_boat_logcat_setLogListener(JNIEnv *env,
                                                          __attribute((unused)) jclass clazz,
