...
LOCAL_SRC_FILES  := xhook/xh_core.c \
                    ...
                    xhook/xh_version.c \
                    xhook/xhook.c\
                    h2co3_boat/h2co3_boat_loadme.c \
                    h2co3_boat/h2co3_boat.c \
                    h2co3_boat/h2co3_boat_clipboard.c \
                    h2co3_boat/h2co3_boat_event.c
...
include $(CLEAR_VARS)
LOCAL_MODULE            := glfw
LOCAL_SHARED_LIBRARIES  := h2co3_boat
LOCAL_SRC_FILES         := glfw/context.c \
                           ...
                           glfw/vulkan.c \
                           glfw/window.c \
                           glfw/h2co3_boat_init.c \
                           glfw/h2co3_boat_monitor.c \
                           glfw/h2co3_boat_window.c \
                           glfw/egl_context.c \
...
LOCAL_STATIC_LIBRARIES  := dyncall \
						   ...
						   dynload
LOCAL_SHARED_LIBRARIES  := h2co3_boat
LOCAL_SRC_FILES         := lwjgl/h2co3_boat_hook.c \
                           ...
                           lwjgl/org_lwjgl_system_h2co3_boat_DynamicLinkLoader.c \
...
LOCAL_CFLAGS            := -O2 -Wall -c -fPIC -std=c99 -Wunused -DLWJGL_H2CO3_Boat -Wunused-value
include $(BUILD_SHARED_LIBRARY)
