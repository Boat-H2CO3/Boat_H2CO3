...
public class H2CO3BoatVirGLService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        new Thread(() -> H2CO3LoadMe.startVirGLService(this, Objects.requireNonNull(getExternalFilesDir("debug")).getAbsolutePath(), getCacheDir().getAbsolutePath())).start();
